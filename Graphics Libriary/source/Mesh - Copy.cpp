...
void demo::loadStars(Vertex* &vertices, int count, float r)
{
...
void demo::createSphere(Vertex* &vertices, WORD* &indices, int slices, int stacks)
{
...
string demo::fileExtension(string& FileName)
{
...
HRESULT demo::loadMeshFromFile_ply(string fileName, vector<Vertex> &vertices, vector<WORD> &indices)
{
...
HRESULT demo::loadMeshFromFile(string fileName, vector<Vertex> &vertices, vector<WORD> &indices)
{
